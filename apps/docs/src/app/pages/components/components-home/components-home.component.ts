  ...
  readonly sections: ComponentDemoSection[] = [
    {
      ...
      components: [
        ...
        },
        {
          ...
          title: 'Slide Toggle',
          description: 'Footer',
          imageUrl: '/assets/slide-toggle.png',
        },
        {
          routerLink: '../components/forms/button-toggle/overview',
          title: 'Button Toggle',
          description: 'Footer',
          imageUrl: '/assets/button-toggle.png',
        },
      ],
    },
    {
      ...
      components: [
        {
          ...
          title: 'Button',
          description: 'Footer',
          imageUrl: '/assets/button.png',
        },
        {
          routerLink: '../components/buttons/badge/overview',
          title: 'Badge',
          description: 'Footer',
          imageUrl: '/assets/badge.png',
        },
        {
    ...
    },
    {
      ...
      components: [
        ...
        },
        {
          ...
          title: 'Sort Header',
          description: 'Footer',
          imageUrl: '/assets/sortable-header.png',
        },
        {
        ...
        },
        {
          ...
          title: 'Empty State',
          description: 'Footer',
          imageUrl: '/assets/empty-state.png',
        },
      ],
    },
    {
      ...
      components: [
        {
          ...
          title: 'Code Block',
          description: 'Footer',
          imageUrl: '/assets/code-block.png',
        },
        {
          routerLink: '../components/utilities/copy-button/overview',
          title: 'Copy Button',
          description: 'Footer',
          imageUrl: '/assets/copy-button.png',
        },
      ],
    },
  ];
